...
def load_dummy_data():
    data = {
        "Nama Produk": [
            ...
            "Smartwatch Anti Air", "Tas Ransel Laptop", "Lampu Tidur LED", "Lipstik Matte Tahan Lama"
        ],
        "Kategori": [
            "Fashion Pria", "Fashion Pria", "Elektronik", 
            "Rumah Tangga", "Kecantikan", "Rumah Tangga",
            "Elektronik", "Fashion Pria", "Rumah Tangga", "Kecantikan"
        ],
        "Harga (Rp)": [150000, 85000, 120000, 45000, 95000, 250000, 180000, 135000, 30000, 65000],
        "Terjual / Bulan": [1200, 850, 3000, 5000, 2500, 400, 1500, 900, 2100, 3200],
        "Komisi (%)": [5, 10, 8, 12, 15, 5, 10, 8, 15, 12],
    }
